...
-   The relationship if @fig-TSG appears to be positive. It looks reasonably linear and am unsure if another fit would align with the data better.
:::
...
-   At a value of 6% white poverty, I might expect `{r} six_pct_prediction$trump_support_hat`% support for Trump.
:::
